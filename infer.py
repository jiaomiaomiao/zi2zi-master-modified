...
parser.add_argument('--model_dir', dest='model_dir', default='experiment/checkpoint',
                    help='directory that saves the model checkpoints')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=16, help='number of examples in batch')
parser.add_argument('--source_obj', dest='source_obj', type=str, default='./experiment/font_binary_data/train.obj', help='the source images for inference')
parser.add_argument('--embedding_ids', default='0,1', type=str, help='embeddings involved')
parser.add_argument('--save_dir', default='./experiment/generated_images/', type=str, help='path to save inferred images')
...
parser.add_argument('--output_gif', dest='output_gif', type=str, default='./experiment/generated_gif', help='output name transition gif')
